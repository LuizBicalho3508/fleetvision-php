...
// Atualizada para cobrir toda a Sidebar
$system_modules = [
    'Monitoramento' => [
        'map_view' => 'Acessar Mapa e Grid',
        'map_history' => 'Visualizar Histórico/Replay',
        'alerts_view' => 'Visualizar Alertas',
    ],
    'Operacional' => [
        'vehicles_view' => 'Veículos: Visualizar',
        'vehicles_manage' => 'Veículos: Criar/Editar/Excluir',
        'drivers_view' => 'Motoristas: Visualizar',
        'drivers_manage' => 'Motoristas: Gerenciar',
        'geofences_view' => 'Cercas Virtuais: Visualizar',
        'geofences_manage' => 'Cercas Virtuais: Gerenciar',
        'journal_view' => 'Jornada de Trabalho',
        'ranking_view' => 'Ranking de Motoristas',
        'commands_send' => 'Enviar Bloqueio/Comandos',
    ],
    'Gestão' => [
        'customers_view' => 'Clientes: Visualizar',
        'customers_manage' => 'Clientes: Gerenciar',
        'financial_view' => 'Financeiro (Asaas)',
        'reports_view' => 'Relatórios',
    ],
    'Administração' => [
        'users_view' => 'Usuários: Visualizar',
        'users_manage' => 'Usuários: Criar/Editar',
        'roles_manage' => 'Perfis de Acesso',
        'branches_manage' => 'Filiais',
        'audit_log' => 'Logs de Auditoria',
    ],
    'Técnico' => [
        'tech_stock' => 'Gestão de Estoque',
        'tech_test' => 'Laboratório de Testes',
        'tech_config' => 'Ícones e Configurações',
    ]
];
?>
...
<body class="bg-slate-50 font-sans text-slate-800">
    ...
    <script>
        // Aponta para a API correta na raiz
        const API_URL = '/api_perfis.php';
        ...
        async function saveProfile() {
            ...
            try {
                ...
                console.error(e);
                alert('Erro ao salvar. Verifique se o arquivo ' + API_URL + ' existe e está acessível.');
            } finally {
        ...
        async function deleteProfile() {
            ...
            try {
                ...
                const data = await res.json();
                if (data.success) { closeModal(); loadProfiles(); } else { alert(data.error || 'Erro ao excluir.'); }
        ...
        async function loadProfiles() {
            ...
            try {
                ...
                grid.innerHTML = `<div class="col-span-full text-center text-red-500 bg-white p-6 rounded-xl border border-red-200">
                    ...
                    <small class="text-slate-500">Não foi possível carregar os perfis. Verifique o console.</small>
                </div>`;
            }
        }
    </script>
